    ...
    <View>
      <View style={styles.titleBox}>
        ...
        <View style={styles.busButtonBox}>
          {selectedRoute?.name === 'TMC' ? (
            <ButtonTMC />
          ) : selectedRoute?.name === 'H221' ? (
            <ButtonH221 />
          ) : selectedRoute?.name === 'Hovey' ? (
            <ButtonHovey />
          ) : null}
        </View>
      </View>
      ...
      {selectedStation?.revisit && (
        <View
          style={[
            styles.timeBlock,
            { justifyContent: 'space-between', width: '100%', backgroundColor: '#00000010' },
          ]}
        >
                ...
                <View key={idx} style={styles.timeBlock}>
                  <Text
                    style={[
                      ...
                      {
                        backgroundColor:
                          labelFirst === nextBusTimeOutbound ? '#eeeeeeff' : 'transparent',
                      },
                    ]}
                  >
                    {labelFirst}
                  ...
                  <Text
                    style={[
                      ...
                      {
                        backgroundColor:
                          labelSecond === nextBusTimeInbound ? '#eeeeeeff' : 'transparent',
                      },
                    ]}
                  >
                    {labelSecond}
            ...
            singleSchedule?.map((time, idx) => (
              <View
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      time === nextBusTimeSingleSchedule ? '#eeeeeeff' : 'transparent',
                  },
                ]}
              >
