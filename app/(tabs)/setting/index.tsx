    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.body}>
          This app was created for a public purpose to help the Camp Casey community navigate base
          shuttle routes using static schedules. The team does not collect personal data, and no GPS
          tracking of buses is used.
        </Text>
        <Text style={styles.bodyKr}>
          본 앱은 공익 목적으로 제작되었으며, 정적 시간표 기반 안내만 제공합니다. 개인정보를
          수집하지 않으며, 버스 GPS 추적 기능은 사용하지 않습니다.
        </Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <TouchableOpacity
          ...
          onPress={() => dial('01031009576')}
          accessibilityLabel="Call 010-3100-9576"
        >
          <FontAwesome6
            name="mobile-screen"
            size={16}
            style={[styles.contactIcon, { color: '#fff' }]}
          />
          <Text style={styles.contactText}>010-3100-9576 (Duty Cell)</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.contactRow}
          onPress={() => dial('05037224718')}
          accessibilityLabel="Call 0503-722-4718"
        >
          <FontAwesome6
            name="phone-flip"
            size={16}
        ...
        <TouchableOpacity
          style={styles.contactRow}
          onPress={() => dial('05037224731')}
          accessibilityLabel="Call 0503-722-4731"
        >
          <FontAwesome6
            name="phone-flip"
            size={16}
