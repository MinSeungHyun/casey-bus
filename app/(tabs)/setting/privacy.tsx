    ...
    <View style={styles.container}>
      <ScrollView style={styles.scroll}>
        ...
        <Text style={styles.paragraph}>
          This privacy policy applies to the CaseyBus app (hereby referred to as "Application") for
          mobile devices that was created by the Service Provider as a Free service. This service is
        ...
        <Text style={styles.paragraph}>
          The Service Provider will retain User Provided data as long as you use the Application and
          for a reasonable time thereafter.
        </Text>

        <Text style={styles.paragraph}>To request deletion of your data, please contact:</Text>
        ...
        <Text style={styles.paragraph}>
          The Service Provider works to protect your data with physical, electronic, and procedural
          safeguards.
        </Text>
        ...
        <Text style={styles.paragraph}>Effective Date: 2025-11-21</Text>

        <Text style={styles.section}>Your Consent</Text>

        <Text style={styles.paragraph}>
          By using the Application, you consent to the processing of your information as described
